...
from typing import Any, Dict, Tuple, Union, Callable, Literal, List, Optional, Iterator, TypedDict
...
from kokikit.dataset import NeRFDataset as _NeRFDataset, Dataset, ImageDataset as _ImageDataset
...
from nodes.KatUIDiffusionBasics.basic import TextEncode
from nodes.KatUIDiffusionBasics.z123 import Z123ImagePartialEmbedding, Z123Embedding
...
class RunMVDreamNeRF(BaseNode):
    ...
    def execute(
        ...
        for step, (t_nerf, loss_weight) in enumerate(pbar):
            ...
            update(field=field, render_variables=variable.ip2render[variable.sid2ip[sid]], timestamp=time.time())
